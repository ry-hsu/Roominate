...
public class Rug extends Furniture {
     ...
     */
    public Rug(int x, int y,int width, int length,String ori) {
    ...
    public String toString() {
        String str = String.format("Rug (%d in x %d in)",super.R_WIDTH/10,super.R_HEIGHT/10);
        return str;
    }
